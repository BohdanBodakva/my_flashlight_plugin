...
abstract class MyFlashlightPluginPlatform extends PlatformInterface {
  ...
  Future<void> turnFlashlightOn() {
    throw UnimplementedError('turnFlashlightOn() has not been implemented.');
  }

  Future<void> turnFlashlightOff() {
    throw UnimplementedError('turnFlashlightOff() has not been implemented.');
  }
}
